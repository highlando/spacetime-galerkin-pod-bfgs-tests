function [erom, Jrom, bfgs_iters, trom] = exper_bfgs(Khat, Jtarget, DEIM_flag)
...
for rr = 1:n_exp 
    ...
    k1 = Khat(rr);    % # POD basis of y
    k2 = 25;          % # DEIM basis
    k3 = Khat(rr);    % # POD basis of u

    Nt = Khat(rr);    % # grid point in time for red model
